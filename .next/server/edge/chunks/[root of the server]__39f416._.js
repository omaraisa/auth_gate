(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/[root of the server]__39f416._.js", {
...
"[project]/app/lib/token.ts [middleware] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$server$2d$only$2f$empty$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/dist/compiled/server-only/empty.js [middleware] (ecmascript)");
...
async function encrypt(payload) {
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$browser$2f$jwt$2f$sign$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["SignJWT"](payload).setProtectedHeader({
        alg: "HS256"
    }).setIssuedAt().setExpirationTime("1h").sign(encodedKey);
}
async function decrypt(token = "") {
    try {
        const { payload } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$browser$2f$jwt$2f$verify$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["jwtVerify"])(token, encodedKey, {
            algorithms: [
                "HS256"
            ]
        });
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$token$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/app/lib/token.ts [middleware] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$request$2f$cookies$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/dist/esm/server/request/cookies.js [middleware] (ecmascript)");
...
async function middleware(req) {
    ...
    const cookie = (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$request$2f$cookies$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["cookies"])()).get("authToken")?.value;
    if (cookie) {
        const token = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$token$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["decrypt"])(cookie);
        if (token?.userId) {
            const currentTime = Math.floor(Date.now() / 1000);
            if (token.exp && token.exp > currentTime) {
                console.log("User is logged in. Redirecting");
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("http://localhost:3000", req.url));
            }
        }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__39f416._.js.map