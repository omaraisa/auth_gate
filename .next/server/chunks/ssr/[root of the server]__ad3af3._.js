...
'use client';
;
// Sample user data (to be replaced with a database call later)
const sampleUser = {
    username: 'admin',
    password: 'oiu'
};
const useLogin = ()=>{
    ...
    const handleLogin = async (formData)=>{
        ...
        // Simulating an async request (e.g., API call)
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__ad3af3._.js.map