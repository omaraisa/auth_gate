...
function LoginForm() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const cookie = document.cookie.split('; ').find((row)=>row.startsWith('arcgis_token='));
        if (cookie) {
            const token = cookie.split('=')[1];
            console.log('Token found:', token);
            router.push(("TURBOPACK compile-time value", "http://localhost:3000") || '/');
        // IdentityManager.registerToken({
        //   server: 'https://www.arcgis.com/sharing/rest',
        //   token,
        //   expires: Date.now() + 60 * 60 * 1000, // 1 hour dummy expiration
        // });
        }
    }, [
        router
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__92a0c9._.js.map